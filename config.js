...
// Auto functioner
global.autoTyping = process.env.AUTO_TYPING || true; //auto typing in cc (true to on,false to off)
global.autoRecord = process.env.AUTO_RECORD || true; //auto recording in (true to on,false to off)
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split("94704224474,") : ["916297175943", "919362639362"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split("94704224474,") : ["916297175943", "919362639362"];
